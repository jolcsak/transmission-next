...
A DSM teljes konténermemóriája a folyamatok RSS-e mellett a visszanyerhető Linux
fájlcache-t is tartalmazza. A mintakonfiguráció ezért nem használ olyan kemény
memórialimitet, kisebb írási cache-t, peer-limitet vagy letöltési sorkorlátot, amely
a csúcssebességet vagy a párhuzamos torrentek teljesítményét visszafoghatná.
